...
io.popen("mkdir BESSO_Files")
t = "\27[35m".."\nAll Files Started : \n____________________\n"..'\27[m'
i = 0
for v in io.popen('ls BESSO_Files'):lines() do
if v:match(".lua$") then
i = i + 1
...
if hash or Bot(msg) or DevBESSO(msg) or BESSODevSou(msg) then    
return true  
else  
return false  
end  
...
if hash or DevBESSO(msg) or DevBot(msg) or BESSODevSou(msg) then     
return true 
else 
return false 
end 
...
if hash or DevBESSO(msg) or DevBot(msg) or BESSODevSou(msg) or creatorA(msg) then     
return true 
else 
return false 
end 
...
if hash or DevBESSO(msg) or DevBot(msg) or BasicConstructor(msg) or BESSODevSou(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or DevBESSO(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or BESSODevSou(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or DevBESSO(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or BESSODevSou(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or  DevBESSO(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or BESSODevSou(msg) or creatorA(msg) then             
return true 
else 
return false 
end 
...
if DevBESSOe(user_id) == true then
var = true
elseif DevBESSO(user_id) == true then
var = true
elseif BESSODevSou(user_id) == true then
var = true
...
if tonumber(user_id) == tonumber(1346349689) then  
var = true  
...
if tonumber(user_id) == tonumber(1346349689) then  
var = 'مطور السورس'
elseif DevBESSOe(user_id) == true then
var = "المطور الاساسي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
...
local url,res = https.request('https://mode-pro.tk/xBESSOx/Johoin.php?id='..msg.sender_user_id_)
...
local UserName = (data.username_ or "BESSO500K")
...
function BESSO_Files(msg)
for v in io.popen('ls BESSO_Files'):lines() do
if v:match(".lua$") then
plugin = dofile("BESSO_Files/"..v)
if plugin.BESSO and msg then
pre_msg = plugin.BESSO(msg)
end
end
end
send(msg.chat_id_, msg.id_,pre_msg)  
end
function BESSO_Started_Bot(msg,data) -- بداية العمل
if msg then
...
local BESSO_Msg = database:sismember(bot_id.."List:Filter:text"..msg.chat_id_,text) 
if BESSO_Msg then    
...
function Function_BESSO(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_BESSO, nil)
return false
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_BESSO, nil)
return false
end
...
if text == ("رفع مطور ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and BESSODevSou(msg) then
function Function_BESSO(extra, result, success)
...
if text and text:match("^رفع مطور ثانوي @(.*)$") and BESSODevSou(msg) then
...
if text and text:match("^رفع مطور ثانوي (%d+)$") and BESSODevSou(msg) then
...
if text == ("حذف مطور ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and BESSODevSou(msg) then
function Function_BESSO(extra, result, success)
...
if text and text:match("^حذف مطور ثانوي @(.*)$") and BESSODevSou(msg) then
...
if text and text:match("^حذف مطور ثانوي (%d+)$") and BESSODevSou(msg) then
...
if text == ("الثانويين") and DevBESSO(msg) then
...
if text == ("مسح الثانويين") and BESSODevSou(msg) then
database:del(bot_id.."DEV:Sudo:T")
send(msg.chat_id_, msg.id_, "\n•  تم مسح قائمة المطورين الثانويين  ")
end
if text == ("مسح قائمه العام") and DevBESSO(msg) then
database:del(bot_id.."GBan:User")
send(msg.chat_id_, msg.id_, "\n• تم مسح قائمه العام")
return false
end
if text == ("مسح المطورين") and DevBESSO(msg) then
...
if text == ("قائمه العام") and DevBESSO(msg) then
...
if text == ("المطورين") and DevBESSO(msg) then
...
if text == ("حظر عام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevBESSO(msg) then
function Function_BESSO(extra, result, success)
...
if text and text:match("^حظر عام @(.*)$")  and DevBESSO(msg) then
...
if result.id_ == tonumber(1346349689) then
...
if text == ("الغاء العام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevBESSO(msg) then
function Function_BESSO(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevBESSO(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevBESSO(msg) then
...
if text == ("رفع مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevBESSO(msg) then
function Function_BESSO(extra, result, success)
...
if text and text:match("^رفع مطور @(.*)$") and DevBESSO(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevBESSO(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id.."Sudo:User", userid)
Reply_Status(msg,userid,"reply","• تم ترقيته مطور في البوت")  
return false 
end
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevBESSO(msg) then
function Function_BESSO(extra, result, success)
...
if text and text:match("^حذف مطور @(.*)$") and DevBESSO(msg) then
...
if text and text:match("^حذف مطور (%d+)$") and DevBESSO(msg) then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local BESSOrt = database:get(bot_id.."Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if BESSOrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"• العضو > ["..data.first_name_.."](t.me/"..(data.username_ or "BESSO500K")..")".."\n• تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA) 
database:sadd(bot_id.."Special:User"..msg.chat_id_,result.sender_user_id_)  
elseif BESSOrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"• العضو > ["..data.first_name_.."](t.me/"..(data.username_ or "BESSO500K")..")".."\n• تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)
database:sadd(bot_id.."Mod:User"..msg.chat_id_,result.sender_user_id_)  
elseif BESSOrt == "مدير" and Constructor(msg) then
send(msg.chat_id_, msg.id_,"• العضو > ["..data.first_name_.."](t.me/"..(data.username_ or "BESSO500K")..")".."\n• تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)  
database:sadd(bot_id.."Manager"..msg.chat_id_,result.sender_user_id_)  
elseif BESSOrt == "عضو" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"• العضو > ["..data.first_name_.."](t.me/"..(data.username_ or "BESSO500K")..")".."\n• تم رفعه "..RTPA.." هنا\n")
end
end,nil)   
end   
...
if result.id_ then
local BESSOrt = database:get(bot_id.."Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if BESSOrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"• العضو > ["..result.title_.."](t.me/"..(text1[3] or "BESSO500K")..")".."\n• تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."Special:User"..msg.chat_id_,result.id_)  
...
function Function_BESSO(extra, result, success)
if result.sender_user_id_ == tonumber(1346349689) then
send(msg.chat_id_, msg.id_, "• لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n•  العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'BESSO')..') '
...
if text == ("مسح ردود المطور") and DevBESSO(msg) then 
...
if text == ("ردود المطور") and DevBESSO(msg) then 
local list = database:smembers(bot_id.."List:Rd:Sudo")
text = "\n• قائمة ردود المطور \n ●○━━━━BE━━━━○●\n"
for k,v in pairs(list) do
...
if text == "اضف رد للكل" and DevBESSO(msg) then 
send(msg.chat_id_, msg.id_,"•  ارسل الكلمه التري تريد اضافتها")
database:set(bot_id.."Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد للكل" and DevBESSO(msg) then 
...
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'BESSO500K')..')'
...
if text == (database:get(bot_id.."Name:Bot") or "بيسو") and GetSourseMember(msg) then      
...
if database:get(bot_id.."Status:Bc") and not DevBESSO(msg) then 
...
لعبة رياضيات >> رياضيات
 ...
 لعبة بات >> بات
•━━━━━━• 
- Ch [BESSO - SoUrCe](https://t.me/BESSO500K)
]]
...
if text == "تنظيف المشتركين" and DevBESSO(msg) then
...
if text == "تنظيف الكروبات" and DevBESSO(msg) then
...
if text == ("تحديث السورس") and DevBESSO(msg) then  
...
send(msg.chat_id_, msg.id_, t..' ●○━━━━BE━━━━○●\n• اضغط على الاسم ليتم نسخه')
end
...
ge = https.request('https://mode-pro.tk/ageApi/BESSOapi.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
send(msg.chat_id_, msg.id_, ag.ok.Rt)
end
if text == 'السيرفر' and DevBESSO(msg) then 
...
if text and text:match("^تعين عدد الاعضاء (%d+)$") and DevBESSO(msg) then
...
if text == 'جلب نسخه احتياطيه' and DevBESSO(msg) then
local list = database:smembers(bot_id..'Chek:Groups')  
local memo = database:smembers(bot_id..'UsersBot')  
local t = '{"BOT_ID": '..bot_id..',"GP_BOT":{'  
for k,v in pairs(list) do   
...
if text == 'الملفات' and DevBESSO(msg) then
t = '• جميع الملفات : \n ●○━━━━BE━━━━○● \n'
i = 0
for v in io.popen('ls BESSO_Files'):lines() do
if v:match(".lua$") then
...
if DevBESSO(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/DEV-NAG/files_BESSO/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n• اهلا بك في متجر ملفات بيسو\n• يوجد في المتجر ملف الردود\n• يتم ادراج الملفات في التحديثات القادمه \n ●○━━━━BE━━━━○● \n"
local TextE = "\n ●○━━━━BE━━━━○● \n• تدل علامة (✔) الملف مفعل\n".."• تدل علامة (✖) الملف معطل\n"
local NumFile = 0
for name,Info in pairs(res.plugins_) do
local Check_File_is_Found = io.open("BESSO_Files/"..name,"r")
...
if text and text:match("^(تعطيل ملف) (.*)(.lua)$") and DevBESSO(msg) then
local name_t = {string.match(text, "^(تعطيل ملف) (.*)(.lua)$")}
local file = name_t[2]..'.lua'
local file_bot = io.open("BESSO_Files/"..file,"r")
if file_bot then
io.close(file_bot)
...
local json_file, res = https.request("https://raw.githubusercontent.com/DEV-NAG/files_BESSO/main/files_BESSO/"..file)
if res == 200 then
os.execute("rm -fr BESSO_Files/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('BESSO.lua')  
else
...
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and DevBESSO(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/DEV-NAG/files_BESSO/main/files_BESSO/"..file)
if res == 200 then
local chek = io.open("BESSO_Files/"..file,'w+')
...
if text == "مسح جميع الملفات" and DevBESSO(msg) then
os.execute("rm -fr BESSO_Files/*")
send(msg.chat_id_,msg.id_,"• تم حذف جميع الملفات")
return false
end
if text == 'نقل الاحصائيات' and DevBESSO(msg) then
...
if text == 'حذف كليشه المطور' and DevBESSO(msg) then
database:del(bot_id..'Text_Dev')
send(msg.chat_id_, msg.id_,'•  تم حذف كليشه المطور')
end
if text == 'وضع كليشه المطور' and DevBESSO(msg) then
...
if text == 'رفع النسخه الاحتياطيه' and DevBESSO(msg) then   
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
if text == "تحديث" and DevBESSO(msg) then
dofile("BESSO.lua")  
send(msg.chat_id_, msg.id_, "• تم التحديث")
end
if text == 'السورس' or text == 'سورس' or text == 'ياسورس' or text == 'يا سورس' and GetSourseMember(msg) then       
Text = "[قناه السورس](t.me/BESSO500K)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'المطور .',url="https://t.me/fsfff"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
if text == 'اريد بوت' or text == 'اريد مطور' or text == 'خوش سورس' or text == 'سورس بيسو' or text == 'اريد بوت تمبلر' or text == 'سورس besso' then
Text = [[
...
if text == '@FSFFF' or text == '@BESSO500K' or text == 'بيسو' then
Text = [[
@FSFFF هذا مطور سورس بيسو
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevBESSO(msg) then
...
if not DevBESSO(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') and not database:get(bot_id.."Filter"..msg.sender_user_id_) then
...
if DevBESSO(msg) and msg.reply_to_message_id_ ~= 0  then    
...
if text =='تغيير المطور الاساسي •' and BESSODevSou(msg) then
send(msg.chat_id_, msg.id_,'• ارسل ايدي المطور الاساسي الجديد')
database:set(bot_id..'Ed:DevBots',true) 
end
if text =='تغيير المطور الاساسي •' and not BESSODevSou(msg) then
send(msg.chat_id_, msg.id_,'• تسرسح')
end
if text == ("مسح الثانويين •") and not BESSODevSou(msg) then
send(msg.chat_id_, msg.id_,'• تسرسح')
end
if text == ("مسح الثانويين •") and BESSODevSou(msg) then
database:del(bot_id.."DEV:Sudo:T")
...
inline = {
{{text = '•  BESSO  .',url='http://t.me/BESSO500K'}},
}
...
------------------------------------------------------------------------
if text then
local BESSO_Msg = database:sismember(bot_id.."List:Filter:text"..result.chat_id_,text) 
if BESSO_Msg then    
